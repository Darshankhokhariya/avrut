    ...
    return (
        <>
            <Swiper
                ...
                <SwiperSlide>
                    <div className="grid lg:grid-cols-2  animate__animated animate__fadeInUp lg:justify-items-center sm:grid-cols-1  place-items-center dark:bg-black animation" data-aos="fade-up">
                        <div className='relative  lg:left-full'>
                            <img src={require('../images/1.jpg')} className='lg:h-[650px] lg:w-[700px] object-cover' alt="" />
                        </div>
